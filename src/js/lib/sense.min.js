...
fireCallback = function(event){
	...
	switch(this.direction){
		case "left":
			if (this.options.onLeft)this.options.onLeft.call(this.options.context, event);
		break;

		case "right":
			if(this.options.onRight) this.options.onRight.call(this.options.context, event);
		break;

		case "up":
			if(this.options.onUp) this.options.onUp.call(this.options.context, event);
		break;

		case "down":
			if(this.options.onDown) this.options.onDown.call(this.options.context, event);
		break;
	}
},
...
TouchMove.prototype = {
	...
	touchmove: function(evt){
		...
		if (shouldAnimate === true) {
			...
			fireCallback.call(this, currentPositionX);
		}
